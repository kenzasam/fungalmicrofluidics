...
class MainFrame(wx.Frame):
    ...
    def __init__(self, setup, imgViewer, path, port=-1, ip='127.0.0.1', columns=2):
        ...
        self.tvwr = os.path.join(build,'wxTempViewer_fungalmicrofluidics.bat') # Path to PID control temperature plotting file
        self.svwr = os.path.join(build,'wxSpecViewer_fungalmicrofluidics.bat') #Path to spectrum plotting file
